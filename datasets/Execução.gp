...
plot 'Dados.txt' using 1:2 with linespoints linestyle 1 title 'MinMax1 (Aleatório)', \
     ...
     '' using 1:5 with linespoints linestyle 4 title 'MinMax2 (Aleatório)', \
     ...
     '' using 1:8 with linespoints linestyle 7 title 'MinMax3 (Aleatório)', \
